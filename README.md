...
| [LAMP選択](#202301281000) | [ブートUSBの作成](#202301281748) | [ブートUSBの起動](#202302092321) | [CentOSインストール](#202302101739) | [Linuxコマンド](#202302121019) | [ルーター](#202302102308) | [SSH](#202302111947) | [Apache](#202302120812) | [FTP](#202302121037) | [vi](#202302130554) | PHP | MySQL | Samba | WordPress |
***
...
1. （[vi](#202302130554)エディタを使いrootユーザーから接続できるようにする  
    ```
