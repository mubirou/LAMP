...
1. インストール  
    ```
    # dnf -y update ←インストール済パッケージをアップデート
    # dnf -y install samba-swat
    ```
    ```
    # dnf list installed | grep samba
    python3-samba.x86_64           4.17.5-0....
    samba.x86_64                   4.17.5-0....
    samba-client-libs.x86_64       4.17.5-0....
    samba-common.noarch            4.17.5-0....
    samba-common-libs.x86_64       4.17.5-0....
    samba-common-tools.x86_64      4.17.5-0....
    samba-dc-libs.x86_64           4.17.5-0....
    samba-dcerpc.x86_64            4.17.5-0....
    samba-ldb-ldap-modules.x86_64  4.17.5-0....
    samba-libs.x86_64              4.17.5-0....
    ```
