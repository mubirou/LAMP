...
1. LAMP選択
    ...
    * [RDBMS](https://db-engines.com/en/ranking) : [MySQL](https://www.mysql.com/jp/) / [**MariaDB**](https://mariadb.com/kb/ja/mariadb/) / [**SQLite**](https://ja.wikipedia.org/wiki/SQLite)  
